...
public class DatabaseHelper {
	...
	public static void initDataBase(){
		String dbType = System.getenv("benchmark_dbtype")!=null?System.getenv("benchmark_dbtype"):System.getProperty("benchmark_dbtype","hsql");
		try {
			...
			{
				executeSQLCommand("CREATE TABLE USERS (userid int NOT NULL AUTO_INCREMENT, username varchar(50), password varchar(50),PRIMARY KEY (userid));");
				executeSQLCommand("CREATE TABLE SCORE (userid int NOT NULL AUTO_INCREMENT, nick varchar(50), score INTEGER,PRIMARY KEY (userid));");
				executeSQLCommand("CREATE PROCEDURE verifyUserPassword(IN username_ varchar(50), IN password_ varchar(50))"
						 
						+ " BEGIN "
						+ " SELECT * FROM USERS WHERE USERNAME = username_ AND PASSWORD = password_ ;"
